...
формальный_анализ(Строка, Рез_конеч) :- 
    ...
    удалить_все_известные_символы(Список_Слов_редакт, Вывод, ['расписание', 'занятия', 'уроки', 'пары', 'лекции', 'завтра', 'сегодня', 'замены', 'изменения', 'оценки', 'отметки', 'успеваемость', 'прогулы']),
    Рез_удаления = Вывод,
