...
формальный_анализ(Строка, Рез_конеч) :- 
    ...
    Рез_Анализа = Список_Слов,
    удалить_все_известные_символы(Список_Слов, Вывод, ['расписание', 'занятия', 'уроки', 'пары', 'лекции', 'завтра', 'сегодня', 'замены', 'изменения', 'оценки', 'отметки', 'успеваемость', 'прогулы']),
    Рез_удаления = Вывод,
