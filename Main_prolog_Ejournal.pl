запрос(Строка_от_Гугла, Смысл, Голосовой_ответ) :-
	формальный_анализ(Строка_от_Гугла, Смысл),
...
формируем_голосовой_ответ(оценки_успеваемость_всей_группы, 'Показываю оценки всей группы').
формируем_голосовой_ответ(ошибка_распознования, 'Запрос не распознан, повоторите').
...
формальный_анализ(Строка, Смысл) :- 
	downcase_atom(Строка, Строка_Down), 
	разборка(Строка_Down, Список_Слов),
    append(Список_Слов, ['qwerty'], Список_Слов_редакт),
    удалить_все_известные_символы(Список_Слов_редакт, Вывод, ['расписание', 'занятия', 'уроки', 'пары', 'лекции',
                                                               'завтра', 'завтрашние', 'сегодня', 'сегодняшние', 'замены', 'изменения',
                                                               'оценки','отметки', 'успеваемость', 'прогулы', 'месяц']),
    удалить_все_известные_символы(Список_Слов_редакт, Рез_конеч, Вывод),
	permutation(Рез_конеч, Рез_конеч_перемеш),
    предложение(Смысл, Рез_конеч_перемеш, []).
...
предложение(ошибка_распознования) --> 
[].
